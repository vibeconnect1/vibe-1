...
//           Bulk Upload 
//         </h2>
//         <form encType="multipart/form-data" action="/site_assets/import" acceptCharset="UTF-8" method="post">
...
//           <button type="submit" name="commit" value="Import" className="bg-black p-1 px-4 border-2 rounded-md text-white font-medium border-black hover:bg-white hover:text-black transition-all duration-300" data-disable-with="Import">
//             Import
//           </button>
//         <a download="assets_import.xlsx" target="_blank" className="bg-black p-1 px-4 border-2 rounded-md text-white font-medium border-black hover:bg-white hover:text-black transition-all duration-300" href="/assets/assets_import.xlsx">
...
const ImportAssetModal = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('/site_assets/import', {
        method: 'POST',
        body: formData,
      });
