...
function Wo() {
    ...
    const column = [
        ...
        { name: "Approved Status", selector: (row) => row.ApprovedStatus, sortable: true },
        { name: "Payment Tenure(In Days)", selector: (row) => row.PaymentTenure, sortable: true },
        { name: "Advance Amount", selector: (row) => row.AdvanceAmount1, sortable: true },
        { name: "Total Amount", selector: (row) => row.TotalAmount, sortable: true },
        { name: "Total Work Completed(%)", selector: (row) => row.TotalWorkCompleted, sortable: true },
        ...
        { name: "No of Invoices", selector: (row) => row.NoOfInvoices, sortable: true },
    ...
    <section className='flex'>
        ...
        <div className="flex  justify-start gap-4 my-5 flex-shrink flex-wrap ">
          ...
          <div className="shadow-xl rounded-full border-4 border-green-400 w-72  px-6 flex flex-col items-center">
            ...
            <p className="text-center font-semibold md:text-lg ">₹ 11,38,13,251</p>
          </div>
