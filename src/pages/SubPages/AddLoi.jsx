...
const AddLoi = () => {
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
    ...
    <div className="col-span-1">
      ...
      <select className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="contact-number" type="text" placeholder="Select Billing Address" />
    </div>
    {scheduleFor === 'PO' && (
    <div className="col-span-1">
      <label className="block text-gray-700 font-bold mb-2" htmlFor="site">Select Delivery Address</label>
      <select className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="site" type="Select Delivery Address" placeholder="Business Bay" />
    </div>)}
