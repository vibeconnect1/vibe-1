                ...
                <div className='flex flex-col'>
                    <div>
                        ...
                        <Select
                          ...
                          isMulti
                          value={formData.groupRemoveMember}
                          onChange={(selectedOption) =>
                          setFormData({ ...formData,groupRemoveMember: selectedOption })
                          }
                       />
                        <button className="bg-red-500 text-white p-1 px-3 rounded-md my-2 mx-3">Remove</button>
                    </div>
                </div>
            </div>
        </div>
