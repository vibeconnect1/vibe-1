      ...
      <div className="m-2">
        ...
        <div className="md:mx-20 my-5 mb-10 sm:border border-gray-400 p-5 px-10 rounded-lg sm:shadow-xl">
            <div className="flex justify-end">
                <button className="flex items-center gap-2 font-medium p-1 px-4 rounded-full border-2 border-black" onClick={toggleEdit}>
                   <BiEdit/> Edit</button>
            </div>
                  ...
                  <div key={i}>
                    <div className="my-5 ">
                      <h2 className="border-b-2 border-black text font-medium">
                       {isEditing ? "Add New Question" : "Questions"}
                      </h2>
                      ...
                      <div className="my-2">
                        ...
                        {data.type === "multiple" && (
                            <>
                         {isEditing ? <div className="grid grid-cols-4 gap-4 my-2">
                            <input
                              type="text"
                              name={`option1_${i}`}
                              id={`option1_${i}`}
