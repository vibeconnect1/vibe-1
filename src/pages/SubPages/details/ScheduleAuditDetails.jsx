...
const ScheduleAuditDetails = () => {
  ...
  const handleToggle2 = () => {
    ...
    const columnDebitNote = [
      ...
      { name: "Trigger Type	", selector: (row) => row.Description, sortable: true },
  ...
  const renderTaskFields = () => (
    <div className="grid md:grid-cols-3 gap-5">
      ...
      <div className="grid gap-2 items-center w-full">
        <label htmlFor="group" className="font-semibold">Checklist Group:</label>
      ...
      <div className="grid gap-2 items-center w-full">
        <label htmlFor="subGroup" className="font-semibold">Checklist SubGroup:</label>
...
{/* <div className="grid gap-2 items-center w-full">
            ...
            <div className="flex flex-col justify-around items-center">
              <div className="flex flex-col w-full">
                <label htmlFor="activityName" className="font-semibold mt-1 mb-2">Activity Name</label>
              ...
              <div className="flex flex-col w-full">
                <label htmlFor="description" className="font-semibold mt-3 mb-2">Description</label>
