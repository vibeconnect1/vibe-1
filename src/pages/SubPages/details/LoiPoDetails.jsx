...
const LOIPoDetails = () => {
  const column = [
    ...
    { name: "BOQ Details", selector: (row) => row.ItemDetail, sortable: true },
    ...
    { name: "UOM", selector: (row) => row.Unit, sortable: true },
    { name: "Rate", selector: (row) => row.Rate, sortable: true },
    { name: "CGST", selector: (row) => row.QCAmount, sortable: true },
    {
      name: "SGST",
      selector: (row) => row.QCOutstanding,
      sortable: true,
    },
    { name: "IGST", selector: (row) => row.NoOfGrns, sortable: true },
    { name: "TCS", selector: (row) => row.NoOfGrns, sortable: true },
  ...
  return (
    <section>
      <div className="border-2 flex flex-col my-9 mx-9 p-4 gap-4 rounded-md border-gray-400">
     ...
     Purchasing Order Details
      ...
      Letter of Indent
        ...
        <div className="grid grid-cols-2 items-center">
            <p>LOI No. </p>
            <p className="text-sm font-normal ">: 1235</p>
          </div>
          <div className="grid grid-cols-2 items-center">
            <p>LOI Date </p>
            <p className="text-sm font-normal ">: 22/03/2024</p>
          </div>
     ...
     Purchasing Order
        ...
        <p>ID</p>
        <p className="text-sm font-normal">: 1242</p>
      </div>
      <div className="grid grid-cols-2 items-center">
        <p>Address</p>
        <p className="text-sm font-normal">: Mumbai - 400352, Maharashtra - India</p>
      </div>
      <div className="grid grid-cols-2 items-center">
        <p>Phone</p>
        <p className="text-sm font-normal">: 13131321</p>
      </div>
      <div className="grid grid-cols-2 items-center">
        <p>Email</p>
        <p className="text-sm font-normal">: sdfvsd@gmail.com</p>
      </div>
      <div className="grid grid-cols-2 items-center">
        <p>GST</p>
      ...
      <div className="grid grid-cols-2 items-center">
        ...
        <p className="text-sm font-normal">: Saturn, PQR Road</p>
      </div>
      ...
      <div className="grid grid-cols-2 items-center">
        <p>Email</p>
        <p className="text-sm font-normal">: Saturn@amail.com</p>
      </div>
      <div className="grid grid-cols-2 items-center">
        <p>Related To</p>
      ...
      <div className="grid grid-cols-2 items-center">
        <p>TDS(%)</p>
        <p className="text-sm font-normal">: 78.0</p>
      </div>
      <div className="grid grid-cols-2 items-center">
        <p>QC(%)</p>
        <p className="text-sm font-normal">:</p>
