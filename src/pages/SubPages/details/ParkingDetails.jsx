...
const ParkingDetails = () => {
  ...
  <h3 className="border-b text-center text-xl border-black mb-6 font-bold">CLIENT PARKING DETAILS</h3>

  <div className="w-full mx-3 my-5 p-5 shadow-lg rounded-lg border border-gray-300">
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
      <div className="col-span-1">
        <label className="block text-gray-700 font-bold mb-2" htmlFor="client-name">Client Name:Shubh Jhaveri</label>
      ...
      <div className="col-span-1">
        <label className="block text-gray-700 font-bold mb-2" htmlFor="start-period">Start Period:01/10/2023</label>
      ...
      <div className="col-span-1">
        <label className="block text-gray-700 font-bold mb-2" htmlFor="end-period">End Period:01/10/2023</label>
