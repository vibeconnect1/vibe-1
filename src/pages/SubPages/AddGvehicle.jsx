  ...
  return (
    ...
    <form className="border border-gray-300 rounded-lg p-4 w-full mx-4">
      ...
      <div className="grid md:grid-cols-3 gap-5">
        ...
        {userType === 'occupant' && (
                <div>
                    <label htmlFor="occupantUser" className="font-semibold">Occupant User:</label><br/>
                    <input type="text" id="occupantUser" name="occupantUser" className="border p-2 rounded-md border-black"/>
                </div>
            )}

            {userType === 'guest' && (
                <div>
                    <label htmlFor="guestName" className="font-semibold">Guest Name:</label>
                    <input type="text" id="guestName" name="guestName" className="border p-2 rounded-md border-black" />
                </div>
            )}
