        ...
        <div className="border-2 flex flex-col my-5 mx-32 p-4 gap-4 rounded-md border-gray-400">
          ...
          {checkbutton && (
              <div className="">
                {visitors.map((visitor, index) => (
                  <div key={index}>
                    <div className="font-semibold border-2 border-black my-3 py-3 px-3 p-1 flex gap-2 flex-col  rounded-md">
                      ...
                      <div className="flex flex-col ">
                          <h2 className="text-sm  font-thin text-left ">
                            Attachments
                          </h2>
                        <div className="font-semibold border-2 border-black  w p-1 flex gap-2 items-start rounded-md">
                        {checkbutton && (
                          <div className="flex">
                              ...
                              <div key={index}>
                                <div className="flex ">  
                                 <FileInputBox className=""/>
                                  &nbsp;&nbsp;
                                 <button onClick={() => handleRemoveVisitor1(index)}><FaTrash /></button>&nbsp;
                                </div>
                              </div>
                            ))}
                          </div>
                        )}
                        <button className="font-semibold border-2 border-black  p-1 flex gap-2 rounded-md" onClick={handleAddVisitor1}><FaPlus/></button>
                        </div>
                      </div>
                ...
                <button className="font-semibold border-2 border-black px-4 p-1 flex gap-2 items-center rounded-md" onClick={handleAddVisitor}>Add</button>
                  <h2 className="text-lg  font-thin text-left my-3">
