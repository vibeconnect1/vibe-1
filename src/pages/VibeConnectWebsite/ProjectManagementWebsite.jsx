...
<p className="text-xl  mb-4 text-justify font-serif text-gray-800 leading-relaxed">Vibe Connect tools is designed to enhance employee productivity, streamline collaboration, and support professional development within organizations. Employee productivity refers to the output generated by an employee within a specific time frame, while efficiency measures how well resources (including time and effort) are utilized to achieve that output.</p>
