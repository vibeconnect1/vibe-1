        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h4 className="text-xl font-semibold text-indigo-600 mb-3">Finance Management</h4>
              <p className="text-gray-600 leading-relaxed">
            ...
            {/* Feature 2 */}
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h4 className="text-xl font-semibold text-indigo-600 mb-3">Employee Management</h4>
              <p className="text-gray-600 leading-relaxed">
            ...
            {/* Feature 3 */}
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h4 className="text-xl font-semibold text-indigo-600 mb-3">Operations</h4>
              <p className="text-gray-600 leading-relaxed">
