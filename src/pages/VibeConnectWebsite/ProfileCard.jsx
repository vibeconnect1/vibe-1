...
const ProfileCard = () => {
  ...
  return (
    <div className="min-h-screen relative bottom-6 bg-cover bg-center" style={{ backgroundImage: 'url("https://reshapecxm.com/adobe-reshaping-cxm/media/86fb22b0b90206d418f7aa214cc1433f/in-2-at-1-38x-full.png")' }}>
      <div className="absolute top-0 right-0 w-full lg:w-1/3 bg-gradient-to-r from-[#008037] to-[#048846] text-white px-4 lg:px-8 py-2 rounded-bl-2xl shadow-lg">
    ...
    {profiles.map((profile, index) => (
      ...
      >
        ...
        <div ref={observerRef} className="lg:w-1/3 py-6 md:py-10 px-4 md:px-12 lg:mr-20 xl:mr-32">
