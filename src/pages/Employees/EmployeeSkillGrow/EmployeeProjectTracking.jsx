...
function EmployeeProjectTracking() {
  ...
  const projectTracking = [
    ...
    },
    {
      ...
      projectSubTitle: "Web Design",
      projectDesc: "Mobile application design is an important application...",
      profiles: [
        { id: 1, src: "/profile1.jpg", alt: "Profile 1" },
        { id: 2, src: "/profile2.jpg", alt: "Profile 2" },
        { id: 3, src: "/profile3.jpg", alt: "Profile 3" },
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 mx-5 my-5">
              {projectTracking.map((item) => (
                ...
                >
                  ...
                  <div className="flex justify-between px-3">
                    ...
                    >
                      ...
                      {activeProjectId === item.id && (
                        ...
                        >
                          <h2 className="text-base font-semibold py-2 text-gray-800 px-4">Setting</h2>
                          <a
                            href="#"
                          ...
                          >
                            <div className="flex gap-2">
                              <FiLink size={15} className="mt-1 text-gray-600" /><span className="text-gray-800">Copy project link</span>
                            </div>
                          </a>
                          <a
                            href="#"
                          ...
                          >
                            <div className="flex gap-2">
                              <FiSave size={15} className="mt-1 text-gray-600" /><span className="text-gray-800">Save</span>
                            </div>
                          </a>
                          <a
                            href="#"
                          ...
                          >
                            <div className="flex gap-2">
                              <HiOutlineDuplicate size={15} className="mt-1 text-gray-600" /><span className="text-gray-800"> Duplicate</span>
                            </div>
                          </a>
                          ...
                          >
                            <div className="flex gap-2">
                              <CiExport size={15} className="mt-1 text-gray-600" /><span className="text-gray-800"> Import</span>
                            </div>
                          </a>
                          <a
                            href="#"
                          ...
                          >
                            <div className="flex gap-2">
                              <LuPrinter size={15} className="mt-1 text-gray-600" /><span className="text-gray-800"> Export / Print</span>
                            </div>
                          </a>
                          <a
                            href="#"
                          ...
                          >
                            <div className="flex gap-2">
                              <AiOutlineTeam size={20} className="mt-1 text-gray-600" /><span className="text-gray-800"> Move to another team</span>
                            </div>
                          </a>
                          <div className="border-t border-gray-300 my-2"></div>
                          <a
                          ...
                          >
                            <div className="flex gap-2">
                              <BsArchive size={15} className="mt-1 text-gray-600" /><span className="text-gray-800"> Archive</span>
                            </div>
                          </a>
                          <a
                            href="#"
                          ...
                          >
                            <div className="flex gap-2">
                              <AiOutlineDelete size={15} className="mt-1 text-gray-600" /><span className="text-gray-800"> Delete Project</span>
                            </div>
                          </a>
                        </div>
                      )}
                    ...
                    <div className="flex">
                      {item.profiles.map((profile, index) => (
                        <img
                          ...
                          src={profile.src}
                          alt={profile.alt}
                          className="w-9 h-9 rounded-full absolute top-0 ml-3"
                          style={{ left: `${index * 1.4}rem` }}
                        />
                      ))}
                    </div>
                    <p
                      className={`p-1 px-2 rounded-md text-sm font-medium ml-auto ${getStatusColor(
                        item.status
                      )}`}
                    >
                      {item.status}
                  ...
                  <div className="flex items-center mt-2 mb-5 px-3">
                    <div
...
export default EmployeeProjectTracking;
