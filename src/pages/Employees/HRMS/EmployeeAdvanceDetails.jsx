    ...
    <div className="flex justify-center items-center my-5 w-full p-4">
      <div className="border border-gray-300 rounded-lg p-4 w-full mx-4">
        ...
        {/* <div className="grid grid-cols-2 items-center">
            ...
            <p className="text-sm font-normal">1038</p>
          </div>
          <div className="grid grid-cols-2 items-center">
          ...
          <div className="grid grid-cols-2 items-center">
            <label className="font-semibold">Advance Date :</label>
            <p className="text-sm font-normal">03/04/2024</p>
          </div>
          <div className="grid grid-cols-2 items-center">
            <label className="font-semibold">Advance Time:</label>
            <p className="text-sm font-normal">9:00AM</p>
          </div>
          <div className="grid grid-cols-2 items-center">
            <label className="font-semibold">Advance Amount:</label>
            <p className="text-sm font-normal">100000</p>
          </div>
          <div className="grid grid-cols-2 items-center">
          ...
          <div className="grid grid-cols-2 items-center">
            <label className="font-semibold">Repayment terms:</label>
...
export default EmployeeAdvanceDetails