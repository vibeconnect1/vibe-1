      ...
      <div className="md:mx-20 my-5 mb-10 sm:border border-gray-400 p-5 px-10 rounded-lg sm:shadow-xl">
        ...
        <div className="w-full mx-3 my-5 p-5 shadow-lg rounded-lg border border-gray-300">
          ...
          <div className="flex flex-col justify-center md:flex-row gap-20">
            ...
            <div>
            <div class="mb-4"> <b>Non Stack Parking</b></div>
            ...
            <div>
              <div className="mb-4"><b>Stack Parking</b></div>
              <div className="w-[310px] h-[200px] border border-black">
                <div className="p-4">
                  <div className="table-responsive">
                    <ul className="border border-gray-400 list-none flex pl-0 items-start flex-wrap w-[280px] h-[170px] overflow-y-scroll scrollbar-thin">
            ...
            <div>
              <div className="mb-4"><b>Reserved Parking</b></div>
              <div className="w-[310px] h-[200px] border border-black">
                <div className="p-4">
                  <div className="table-responsive">
                    <ul className="border border-gray-400 list-none flex pl-0 items-start flex-wrap w-[280px] h-[170px] overflow-y-scroll scrollbar-thin">
        ...
        <div className="w-full mx-3 my-5 p-5 shadow-lg rounded-lg border border-gray-300">
          ...
          <div className="flex flex-col justify-center md:flex-row gap-20">
            ...
            <div>
              <div className="mb-5"><b>Non Stack Parking</b></div>
              <div className="w-[310px] h-[200px] border border-black">
                <div className="p-4">
                  <div className="table-responsive">
                    <ul className="border border-gray-400 list-none flex pl-0 items-start flex-wrap w-[280px] h-[170px] overflow-y-scroll scrollbar-thin">
            ...
            <div>
              <div className="mb-5"><b>Stack Parking</b></div>
              <div className="w-[310px] h-[200px] border border-black">
                <div className="p-4">
                  <div className="table-responsive">
                    <ul className="border border-gray-400 list-none flex pl-0 items-start flex-wrap w-[280px] h-[170px] overflow-y-scroll scrollbar-thin">
            ...
            <div>
              <div className="mb-5"><b>Reserved Parking</b></div>
              <div className="w-[310px] h-[200px] border border-black">
                <div className="p-4">
                  <div className="table-responsive">
                    <ul className="border border-gray-400 list-none flex pl-0 items-start flex-wrap w-[280px] h-[170px] overflow-y-scroll scrollbar-thin">
