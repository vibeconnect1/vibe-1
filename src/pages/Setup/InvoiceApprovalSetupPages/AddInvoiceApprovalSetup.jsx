...
function AddInvoiceApprovalsSetup() {
    const [invoiceApproval, setInvoiceApproval] = useState([{ nameLevel: '', order: '' }]);
  ...
  return (
    <section className='flex'>
        ...
        <div className="w-full flex  flex-col overflow-hidden">
            <h2 className="text-center md:text-xl font-bold p-2 bg-black rounded-full text-white mx-3 my-3 mb-5">
               Add Invoice Approval
            </h2>
            <div className='flex justify-center '>
            <div className=' w-3/4 border-2 border-black rounded-md mb-10'>
