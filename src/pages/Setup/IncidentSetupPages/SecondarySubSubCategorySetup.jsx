...
import SecondarySubSubCategorySetupModal from '../../../containers/modals/IncidentSetupModal/SecondarySubSubCategorySetupModal';
        ...
        { name: "Secondary Sub Sub Category", selector: (row) => row.SecondarySubSubCategory, sortable: true },
        {
            ...
            cell: (row) => (
              <div className="flex items-center gap-4">
                ...
                {modal && <SecondarySubSubCategorySetupModal onclose={() => showModal(false)} />}
                <Link to="">
