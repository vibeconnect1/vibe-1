...
const TicketEscalationSetup = () => {
  ...
  return (
    ...
    <tbody>
      <tr>
        <td class="border border-gray-300 px-4 py-2 text-center">E1</td>
        <td class="border border-gray-300 px-4 py-2 text-center"><select name="" id="" className="border p-2 rounded-md border-black w-full">
          <option value="">Rohit</option> <option value="">Ramesh</option>
          </select></td>
      </tr>
      <tr>
        <td class="border border-gray-300 px-4 py-2 text-center">E2</td>
        <td class="border border-gray-300 px-4 py-2 text-center"><select name="" id="" className="border p-2 rounded-md border-black w-full">
        <option value="">Rohit</option> <option value="">Ramesh</option></select></td>
      </tr>
      <tr>
        <td class="border border-gray-300 px-4 py-2 text-center">E3</td>
        <td class="border border-gray-300 px-4 py-2 text-center"><select name="" id="" className="border p-2 rounded-md border-black w-full">
        <option value="">Rohit</option> <option value="">Ramesh</option></select></td>
      </tr>
      <tr>
        <td class="border border-gray-300 px-4 py-2 text-center">E4</td>
        <td class="border border-gray-300 px-4 py-2 text-center"><select name="" id="" className="border p-2 rounded-md border-black w-full">
        <option value="">Rohit</option> <option value="">Ramesh</option></select></td>
      </tr>
      <tr>
        <td class="border border-gray-300 px-4 py-2 text-center">E5</td>
        <td class="border border-gray-300 px-4 py-2 text-center"><select name="" id="" className="border p-2 rounded-md border-black w-full">
        <option value="">Rohit</option> <option value="">Ramesh</option></select></td>
      </tr>
    </tbody>
  ...
  <button
         ...
         <label htmlFor="" className="font-semibold" style={{ fontSize: '20px' }}>Filter</label></div>

         <select name="" id="" className="border p-2 rounded-md border-black w-64">
...
style={{ background:themeColor}}
  ...
  <FaTrash/>
  <button onClick={openModal1}><RiContactsBook2Line/></button>
  {/* <MdHelp/> */}
</div>
...
<Table
       ...
       <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
          ...
          {/* <h1>Clone Data</h1> */}
          <h2 className="text-xl text-center font-semibold mb-4">Clone Data</h2>
...
<table class="border-collapse">
    ...
    <tbody>
      <tr>
        ...
        <td class="border border-gray-300 px-4 py-2"><select name="" id="" className="border p-2 rounded-md border-black w-48"
        >
          <option value="">Mittu</option>
          <option value="">Panda</option></select></td>
        <td class="border border-gray-300 px-4 py-2">
          <div className="flex gap-2">
        <input type="number" class="w-12 h-30 border border-gray-300 rounded-md px-2 py-1 " placeholder="Days"/>
<input type="number" class="w-12 h-30 border border-gray-300 rounded-md px-2 py-1 " placeholder="Hrs"/>
<input type="number" class="w-12 h-30 border border-gray-300 rounded-md px-2 py-1" placeholder="Min"/></div>
        </td>
        <td class="border border-gray-300 px-4 py-2">
          <div className="flex gap-2">
        <input type="number" class="w-12 h-30 border border-gray-300 rounded-md px-2 py-1 " placeholder="Days"/>
     ...
     >
      ...
      {showModal3 && (
       <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
          ...
          <h2 className="text-xl text-center font-semibold mb-4">Edit</h2>
            <div className=" flex flex-col gap-2">
              <div>
          <select name="" id=""  className="border p-2 rounded-md border-black w-64 h-10 "

><option value="">Select</option><option value="">pantry</option>
<option value="">Housekeeping</option>
<option value="">others</option>
</select></div>
 <div><table class="border-collapse">
    <thead>
      <tr>
        <th class="border border-gray-300 bg-gray-100 px-4 py-2">Levels</th>
        <th class="border border-gray-300 bg-gray-100 px-4 py-2">Escalation To</th>
...
style={{ background:themeColor }}
     ...
     <p className="font-semibold">Rule 1</p>
     <div className="flex gap-2 justify-end  mb-1">
  <button onClick={openModal3}><BiEdit /></button>
  <FaTrash/>
  <button onClick={openModal1}><RiContactsBook2Line/></button>
  {/* <MdHelp/> */}
</div>
