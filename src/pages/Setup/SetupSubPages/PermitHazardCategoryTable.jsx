...
const PermitHazardCategoryTable = () => {
  ...
  const column = [
    ...
    { name: "Permit Hazard Category", selector: (row) => row.type, sortable: true },
    ...
    <section className="flex ">
      ...
      <div className="w-full flex mx-3 flex-col overflow-hidden">
        ...
        <div className=" flex m-3 flex-col">
          <div className="flex jgap-2 items-center">
            <input
              type="text"
         ...
         <div>
         <label htmlFor="" className="font-semibold">SubCategory</label>
         <select name="" id="" className="border border-gray-400 p-2 rounded-md w-full">
         <option value="">Category1</option>
          <option value="">Category2</option>
         </select>
