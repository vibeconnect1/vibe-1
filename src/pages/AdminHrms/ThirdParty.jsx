    ...
    <section className="flex gap-1 ml-20">
     ...
     <UserDetailsList/> */}
      ...
      <div className=" w-2/3 flex my-3 flex-col overflow-hidden">
                        ...
                        <div>
                          ...
                          <div className="p-6 bg-white shadow-custom-all-sides rounded-md">
                            <div className="flex justify-between items-center">
                              ...
                              >
                                {isOpen ? <FaChevronDown/>  : <FaAngleRight size={20}/>}
                              </button>
                            </div>
                            {isOpen && (
                          ...
                          <div className="p-6 bg-white shadow-custom-all-sides rounded-md">
                            <div className="flex justify-between items-center">
                              ...
                              >
                                {isOpen1 ? <FaChevronDown/>  : <FaAngleRight size={20}/>}
                              </button>
                            </div>
                            {isOpen1 && (
                              <div className="mt-4 space-y-4 w-4/5">
                          ...
                          <div className="p-6 bg-white shadow-custom-all-sides rounded-md">
                            <div className="flex justify-between items-center">
                              ...
                              >
                                {isOpen2 ? <FaChevronDown/>  : <FaAngleRight size={20}/>}
                              </button>
                            </div>
                            {isOpen2 && (
                              <div className="mt-4 space-y-4 w-4/5">
        ...
        {showModal1 && (
          <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
            <div className="bg-white p-4 rounded-lg max-h-[90%] overflow-y-auto ">
              <h1 className="text-2xl font-bold mb-2">Add Third Party Users</h1>
              {/* <div className=""> */}
              <div className="flex gap-2 items-end">
                <div className="flex flex-col gap-2">
              ...
              <div className="grid grid-cols-2 gap-2 my-2">
                <div className="flex gap-2 flex-col">
                  ...
                  <input
                    type="text"
                    name="name"
                    className="border border-gray-300 p-2 w-72 rounded "
                    placeholder="Enter Full Name"
                  />
                </div>
                <div className="flex gap-2 flex-col">
      ...
      <div className="my-4 ml-1 w-fit">
        <div className="flex flex-col mt-4 mr-1 shadow-custom-all-sides bg-gray-50 rounded-md text-wrap  gap-4 my-2 py-2 pl-5 pr-2 w-[18rem]">
          <div className="flex text-sm gap-4 font-medium">
            <GrHelpBook size={20} />
            <h2>Help Center</h2>
          </div>
          <div className=" ">
