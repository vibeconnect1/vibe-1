        ...
        <div className="origin-top-right z-30 absolute right-0 mt-10 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
          ...
          >
            ...
            <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
              ...
              <button onClick={() => setIsModalOpen1(true)}>Bulk Approve </button>
            </a>
            <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
              {/* Upload Documents */}
              <button onClick={() => setIsModalOpen2(true)}>Bulk Reject</button>
            </a>
            <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
              {/* Bulk Update Employee Data */}
              <button onClick={() => setIsModalOpen3(true)}>Bulk Upload Loan </button>
          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="">
                  <div className="mt-3  sm:mt-0 sm:ml-1 ">
                   ...
                   <p>Step 1: Download loan application information global format

Includes all your Employees with their available details.</p>
<button
          ...
          >
            Download
                    ...
                    <div className="mb-4">
                      <label htmlFor="reason" className="block text-sm font-medium text-gray-700 mb-1">
                      Step 2: Make necessary changes in the downloaded file or add new row(s) to create new loan application(s) and upload *
                      </label>
                     <FileInputBox/>
                    </div>
                  </div>
