  ...
  const columns = [
    {
      ...
      cell: (row) => (
        <div className="flex gap-2 items-center gap-4">
          <Link
            to={`/admin/details-payslip/${row.id}`}
          >
            <BsEye size={15} />

          </Link>
          <button onClick={() => setIsModalOpen2(true)}><FaFileAlt size={15}/></button>
          
          <button onClick={() => setIsModalOpen1(true)}><FaCheck size={15}/></button>
        </div>
      ),
    },
    {
  ...
  const data = [
    {
      ...
      Location: "June-2024	",
      City: "0",
      State:   <button onClick={() => setIsModalOpen(true)} className="px-4 py-2 bg-blue-600 text-white rounded-md" >
      Generate
    </button>,
      Label: "0",
      Country: "India",
    ...
    <section className="flex ml-20">
      ...
      <div className=" w-full flex m-3 flex-col overflow-hidden">
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-10">
          <div className="bg-white p-6 rounded-lg w-96 h-4/6 overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-bold">Generate Bulk Payslips for June-2024</h2>
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-10">
          <div className="bg-white p-6 rounded-lg w-96 h-4/6 overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-bold">Publish Payslips for June - 2024</h2>
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-10">
          <div className="bg-white p-6 rounded-lg w-96 h-4/6 overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-bold">UnPublish Payslips for June - 2024</h2>
