    ...
    <div className="flex ">
      ...
      <div className="w-72 h-full bg-white shadow-lg p-4 mt-9">
        <ul className="space-y-4">
          ...
          <li>
            <NavLink
              to="/admin/hrms/ctc/ctc-template/Component"
              className={({ isActive }) =>
                `${
                  isActive
                    ? "text-white bg-blue-500 flex p-2 gap-3.5 rounded-md group items-center text-sm font-medium"
            ...
            >
              ...
              >
               Component and Hierarchy selection
              </h2>
            </NavLink>
          </li>
          <li>
            <NavLink
              to="/admin/hrms/ctc/ctc-template/Restrictions"
              className={({ isActive }) =>
                `${
                  isActive
                    ? "text-white bg-blue-500 flex p-2 gap-3.5 rounded-md group items-center text-sm font-medium"
            ...
            >
              ...
              >
               <p> Restrictions on CTC Basket and</p>
                 Amount Allocation
              </h2>
              <h2
                className={`${
              ...
              >
               Restrictions on CTC Basket and Amount Allocation
              </h2>
            </NavLink>
          </li>
