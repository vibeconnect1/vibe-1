    ...
    <div className="flex">
      ...
      <div className="w-72 h-full bg-white shadow-lg p-4 mt-9">
        <ul className="space-y-4">
          ...
          <li>
            <NavLink
              to="/admin/add-employee/Employment"
              className={({ isActive }) =>
                `${
                  isActive
                    ? "text-white bg-blue-500 flex p-2 gap-3.5 rounded-md group items-center text-sm font-medium"
          ...
          <li>
            <NavLink
              to="/admin/add-employee/Statutory"
              className={({ isActive }) =>
                `${
                  isActive
                    ? "text-white bg-blue-500 flex p-2 gap-3.5 rounded-md group items-center text-sm font-medium"
...
export default AddEmployeeDetailsList;