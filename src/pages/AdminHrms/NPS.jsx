...
const NPS = () => {
  ...
  return (
    ...
    <div className="ml-10 w-2/3 p-8 bg-white shadow-md rounded-lg">
    <div className='flex justify-between'>
      ...
      <div className="mb-4">
        <label className="block font-semibold">Is your company registered under NPS?</label>
              ...
              <ul style={listItemStyle} className="flex flex-col gap-2">
                <li>
                  <ul style={listItemStyle}>
                    <li>
                    If your organization has NPS Policy where certain portion of the salary is get contribution to NPS account then you can configure the default setting here.                    </li>
                  </ul>
                </li>
                <li>
                  <ul style={listItemStyle}>
                    <li>
                    Further You need map require setting in employee salary Tax and Statutory settings at the time of entering CTC details for applicable employee.
