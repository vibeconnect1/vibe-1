...
const OtherBenefit = () => {
  ...
  const data = [
    { Name: "person 1", Location: "Tax", City: "Mumbai", State: "Maharashtra", Country: "India" },
  ];
              ...
              <ul style={listItemStyle} className="flex flex-col gap-2">
                <li>
                  <ul style={listItemStyle}>
                    <li>
                    Other benefits the one which are not paid directly to employees through the salary; however, it is a part of their CTC. E.g. Insurance Premium paid by employer, any fixed reimbursement paid off the salary etc.      </li>
                  </ul>
                </li>
                <li>
                  <ul style={listItemStyle}>
                    <li>
                    There is an option to map these as well to the employee CTC.             </li>
                  </ul>
                </li>
                {/* <li>
                  <ul style={listItemStyle}>
