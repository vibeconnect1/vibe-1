...
const SectionSalary = () => {
  ...
  const [isEmployerContributionsVisible, setEmployerContributionsVisible] = useState(false);
  const [isEmployeeDeductionsVisible, setEmployeeDeductionsVisible] = useState(false);
  const [isOpen, setIsOpen] = useState(false);
  const column = [
    {
      name: "view",
    ...
    <div className='flex flex-col ml-20'>
        ...
        <div className='flex'>
            ...
            trigger={
              <CustomTrigger isOpen={isOpen}>
                <h2 className="text-2xl font-bold mb-6">Salary  Information</h2></CustomTrigger>
            }
      ...
      <div className="fixed inset-0 flex items-center justify-center z-10 bg-gray-800 bg-opacity-50">
        <div className="bg-white p-8 rounded-lg shadow-lg w-2/4 max-h-screen overflow-y-auto">
          ...
          <div className="mb-4">
            <p><strong>Payroll Effective Date:</strong> 01-04-2023</p>
            <p><strong>Actual Effective Date:</strong> 01-04-2023</p>
            <p><strong>Auto Salary Revision Arrears Required?</strong> No</p>
            <p><strong>Selected CTC Template:</strong> Enter Manually</p>
            <p><strong>Entered CTC Amount:</strong> 0</p>
          </div>
          <div className="mb-4">
            <p className="cursor-pointer" onClick={() => setTaxSettingsVisible(!isTaxSettingsVisible)}>
              Tax and Statutory Settings {isTaxSettingsVisible ? '-' : '+'}
            </p>
            {isTaxSettingsVisible && (
              <div className="ml-4">
                <p><strong>PF Deduction:</strong> No</p>
                <p><strong>Provident Pension Deduction:</strong> No</p>
                <p><strong>Employee's Provident Fund contribution capped at the PF Ceiling?</strong> No</p>
                <p><strong>Employer's Provident Fund contribution capped at the PF Ceiling?</strong> No</p>
                <p><strong>PF Wage:</strong> 0</p>
                <p><strong>ESIC Deduction:</strong> No</p>
                <p><strong>PT Deduction:</strong> Yes</p>
                <p><strong>LWF Deduction:</strong> No</p>
                <p><strong>Income Tax Deduction:</strong> No</p>
                <p><strong>NPS Deduction:</strong> No</p>
              </div>
            )}
          </div>
          <div className="mb-4">
          <div className="flex justify-between">
            ...
            <p className="cursor-pointer" onClick={() => setCTCComponentsVisible(!isCTCComponentsVisible)}>
          ...
          <div className="mb-4">
            <p className="cursor-pointer" onClick={() => setEmployerContributionsVisible(!isEmployerContributionsVisible)}>
              Total Employer Statutory Contributions {isEmployerContributionsVisible ? '-' : '+'}
            </p>
          ...
          <div className="mb-4">
            <p className="cursor-pointer" onClick={() => setEmployeeDeductionsVisible(!isEmployeeDeductionsVisible)}>
              Total Employee Statutory Deductions {isEmployeeDeductionsVisible ? '-' : '+'}
            </p>
            {isEmployeeDeductionsVisible && (
              <div className="ml-4">
                <div className="mt-4 space-y-4 w-4/5">
                  <hr/>
                   <div className="flex justify-between">
                     <label className="text-gray-600 ">Employee PF Contribution</label>
                     <p className="ml-4">0</p>
                     <p>0</p>
                   </div>
                   <div className="flex justify-between">
                     <label className="text-gray-600">Employee ESIC Contribution</label>
                     <p className="ml-1">0</p>
                     <p>0</p>
                   </div>
                   <div className="flex justify-between">
                     <label className="text-gray-600">Employee LWF Contribution</label>
                     <p className="">0</p>
                     <p>0</p>
                   </div>
                   <div className="flex justify-between">
                     <label className="text-gray-600">Employee PT Deduction</label>
                     <p className="">0</p>
                     <p>0</p>
                   </div>
                   <div className="flex justify-between">
                     <label className="text-gray-600">Employee NPS Deduction</label>
                     <p>0</p>
                     <p>0</p>
                   </div>
                 </div>
          ...
          <button onClick={() => setisopen(false)} className="mt-4 bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-700">
            Close
          </button>
        </div>
      </div>
