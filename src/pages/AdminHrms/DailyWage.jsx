...
const DailyWage = () => {
  ...
  const monthsData = [
    ...
    { month: 'February', date: 18 },
    { month: 'March', date: 18 },
    { month: 'April', date: 18 },
    { month: 'May', date: 18 },
    { month: 'June', date: 18 },
    { month: 'July', date: 18 },
    { month: 'August', date: 18 },
    { month: 'September', date: 18 },
    { month: 'October', date: 18 },
    { month: 'November', date: 18 },
    { month: 'December', date: 18 },
  ];
  return (
    ...
    <div className="max-w-3xl  p-8 bg-white shadow-md rounded-lg">
      ...
      <h1>Months and Dates</h1>
      <label htmlFor="">January</label>&nbsp;
      <input type="number" className="border border-gray-400 p-2 rounded-md"  /><br/>
