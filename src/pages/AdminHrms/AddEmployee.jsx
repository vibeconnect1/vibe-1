  ...
  return (
    ...
    <div className= "w-full p-6 bg-white rounded-lg shadow-md">
      ...
      <div className="grid gap-2 items-center w-full">
            ...
            <input type="text" className="border border-gray-400 p-2 rounded-md" placeholder="First Name" required />
          </div>
          <div className="grid gap-2 items-center w-full">
            <label className="block text-sm font-medium text-gray-700">Last Name *</label>
            <input type="text" className="border border-gray-400 p-2 rounded-md" placeholder="Last Name" required />
          </div>
          <div className="grid gap-2 items-center w-full">
            <label className="block text-sm font-medium text-gray-700">Email ID *</label>
            <input type="email"className="border border-gray-400 p-2 rounded-md" placeholder="Email" required />
          </div>
          <div className="grid gap-2 items-center w-full">
            <label className="block text-sm font-medium text-gray-700">Mobile</label>
            <input type="tel" className="border border-gray-400 p-2 rounded-md" placeholder="Mobile Number" />
          </div>
          <div className="grid gap-2 items-center w-full">
            <label className="block text-sm font-medium text-gray-700">Gender *</label>
            <select className="border border-gray-400 p-2 rounded-md" required>
          ...
          <div className="grid gap-2 items-center w-full">
            ...
            <input type="date" className="border border-gray-400 p-2 rounded-md" required />
          </div>
          <div className="grid gap-2 items-center w-full">
  ...
  <select className="border border-gray-400 p-2 rounded-md" required>
    ...
    <option value="O+">O+</option>
          ...
          <div className="grid gap-2 items-center w-full">
            ...
            <input type="text" className="border border-gray-400 p-2 rounded-md" placeholder="PAN NUMBER" />
          </div>
          <div className="grid gap-2 items-center w-full">
            <label className="block text-sm font-medium text-gray-700">Aadhar No</label>
            <input type="text" className="border border-gray-400 p-2 rounded-md" placeholder="Aadhar Number" />
          </div>
          <div className="grid gap-2 items-center w-full">
          ...
          <div className="grid gap-2 items-center w-full">
            ...
            <input type="text" className="border border-gray-400 p-2 rounded-md" placeholder="Emergency Contact Name" />
          </div>
          <div className="grid gap-2 items-center w-full">
            <label className="block text-sm font-medium text-gray-700">Emergency Contact No.</label>
            <input type="text" className="border border-gray-400 p-2 rounded-md" placeholder="Emergency Contact Number" />
          </div>
        </div>

        {/* <h3 className="text-xl font-bold mt-6 mb-4">Family Information</h3> */}
        <h2 className="border-b text-center text-xl border-black mt-4 mb-6 font-bold mt-2">
        Family Information
          </h2>
          <div className="grid md:grid-cols-3 gap-5 mt-5">
          <div className="grid gap-2 items-center w-full">
            <label className="block text-sm font-medium text-gray-700">Father's Name</label>
            <input type="text" className="border border-gray-400 p-2 rounded-md" placeholder="Father's Name" />
          </div>
          <div className="grid gap-2 items-center w-full">
            <label className="block text-sm font-medium text-gray-700">Mother's Name</label>
            <input type="text" className="border border-gray-400 p-2 rounded-md" placeholder="Mother's Name" />
          </div>
          <div className="grid gap-2 items-center w-full">
            <label className="block text-sm font-medium text-gray-700">Spouse's Name</label>
            <input type="text" className="border border-gray-400 p-2 rounded-md" placeholder="Spouse's Name" />
          </div>
        </div>

        {/* <h3 className="text-xl font-bold mt-6 mb-4">Address Information</h3> */}
        <h2 className="border-b text-center text-xl mt-4 border-black mb-6 font-bold mt-2">
        Address Information
          </h2>
          <div className="grid md:grid-cols-3 gap-5 mt-5">
          <div className="grid gap-2 items-center w-full">
            <label className="block text-sm font-medium text-gray-700">Address Line 1</label>
            <input type="text" className="border border-gray-400 p-2 rounded-md" placeholder="Address Line 1" maxLength="150" />
          </div>
          <div className="grid gap-2 items-center w-full">
            <label className="block text-sm font-medium text-gray-700">Address Line 2</label>
            <input type="text" className="border border-gray-400 p-2 rounded-md" placeholder="Address Line 2" maxLength="150" />
          </div>
          <div className="grid gap-2 items-center w-full">
            <label className="block text-sm font-medium text-gray-700">Country</label>
            <input type="text" className="border border-gray-400 p-2 rounded-md" placeholder="Country" />
          </div>
          <div className="grid gap-2 items-center w-full">
            <label className="block text-sm font-medium text-gray-700">State/Province</label>
            <input type="text" className="border border-gray-400 p-2 rounded-md" placeholder="State/Province" />
          </div>
          <div className="grid gap-2 items-center w-full">
            <label className="block text-sm font-medium text-gray-700">City</label>
            <input type="text" className="border border-gray-400 p-2 rounded-md" placeholder="City" />
          </div>
          <div className="grid gap-2 items-center w-full">
            <label className="block text-sm font-medium text-gray-700">Zip / Pin Code</label>
            <input type="text" className="border border-gray-400 p-2 rounded-md" placeholder="Zip / Pin Code" />
          </div>
        </div>
              ...
              <ul style={listItemStyle} className="flex flex-col gap-2">
                <li>
                  <ul style={listItemStyle}>
                    <li>
                    Add basic employee details such as Name, Email ID, Contact Number, Gender, DoB, PAN and AADHAR Number.         </li>
                  </ul>
                </li>
                <li>
                  <ul style={listItemStyle}>
...
Any custom fields added in Organisation {">"} Organisation Settings {">"} Employee Fields {">"} Personal Details will be reflected on the page               </p>
                </li>
