...
const LeavePendingApp = () => {
  ...
  return (
    <section className="flex">
      <div className="w-full flex m-3 flex-col overflow-hidden">
        <div className="flex justify-end gap-2 mr-2 my-5">
          <input
            type="text"
        ...
        <div className="origin-top-right z-30 absolute right-0 mt-20 w-72 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
          <div className="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
            <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
              <button onClick={() => setIsModalOpen1(true)} >Add Single Leave Applications</button>
              
            </a> 
            <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
            <button  onClick={() => setIsModalOpen2(true)}>Add Multiple Leave Applications</button>
            </a>
            <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
              {/* Upload Documents */}
              <button onClick={() => setIsModalOpen3(true)}>Approve multiple requests</button>
            </a>
            <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
              {/* Bulk Update Employee Data */}
              <button onClick={() => setIsModalOpen4(true)}>Bulk Approve by filters </button>

            </a>
            <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
              {/* Bulk Add New Employees */}
              <button onClick={() => setIsModalOpen5(true)}>Approve multiple requests</button>
            </a>
            <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
              
              <button onClick={() => setIsModalOpen6(true)}>Bulk Reject by filters</button>

            </a>
            <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
             
              <button onClick={() => setIsModalOpen7(true)}>Bulk Approve Cancel Leave</button>

            </a>
            <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
              {/* Bulk Update Payment Information */}
   
              <button onClick={() => setIsModalOpen8(true)}>Bulk Reject Cancel Leave</button>
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex z-10 justify-center items-center">
          <div className="bg-white p-5 rounded-md shadow-md w-2/3">
            ...
            <div className="grid gap-2 items-center w-full">
             ...
             <option value="">LWP</option></select>   
            ...
            <div className="grid gap-2 items-center w-full ">
              ...
              <select
                ...
                className="mt-1 block w-full border border-gray-400 p-2 rounded-md"
              >
                <option value="" disabled>Level 1 Approval Pending</option>
                <option value="" disabled>Level 2 Approval Pending</option>
              </select>
            </div>
            <div className="grid gap-2 items-center w-full ">
              <label htmlFor="headOfDepartment" className="block text-sm font-medium text-gray-700">
 ...
 />
            ...
            <div className="grid gap-2 items-center w-full ">
              ...
              <select
                ...
                className="mt-1 block w-full border border-gray-400 p-2 rounded-md"
              >
                <option value="" disabled>Imcomplete</option>
          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="">
                  <div className="mt-3  sm:mt-0 sm:ml-1 ">
                   ...
                   <p>Are you sure you would like to Approve the selected leave requests?</p>
                    <div className="mb-4">
                      <label htmlFor="reason" className="block text-sm font-medium text-gray-700 mb-1">
                      Approver Comment
                      </label>
       ...
       {isModalOpen4 && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex z-10 justify-center items-center">
          <div className="bg-white p-5 rounded-md shadow-md w-2/3">
            <h2 className="text-xl font-semibold mb-4">Bulk Approve Leave Applications by Filters</h2>
            <div className="grid md:grid-cols-3 gap-5 mt-5">
            <div className="grid gap-2 items-center w-full">
              <label htmlFor="departmentName" className="block text-sm font-medium text-gray-700">
              Leave Categories
 ...
 />
          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="">
                  <div className="mt-3  sm:mt-0 sm:ml-1 ">
                   ...
                   <p>Are you sure you would like to reject the selected leave requests?</p>
                    <div className="mb-4">
                      <label htmlFor="reason" className="block text-sm font-medium text-gray-700 mb-1">
                      Approver Comment
                      </label>
       ...
       {isModalOpen6 && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex z-10 justify-center items-center">
          <div className="bg-white p-5 rounded-md shadow-md w-2/3">
            <h2 className="text-xl font-semibold mb-4">Bulk Reject Leave Applications by Filters</h2>
            <div className="grid md:grid-cols-3 gap-5 mt-5">
            <div className="grid gap-2 items-center w-full">
              <label htmlFor="departmentName" className="block text-sm font-medium text-gray-700">
              Leave Categories
          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="">
                  <div className="mt-3  sm:mt-0 sm:ml-1 ">
                   ...
                   <p>Are you sure you would like to Approve Leave Cancellation for selected leave requests?</p>
                    <div className="mb-4">
                      <label htmlFor="reason" className="block text-sm font-medium text-gray-700 mb-1">
                      Approver Comment
                      </label>
          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="">
                  <div className="mt-3  sm:mt-0 sm:ml-1 ">
                   ...
                   <p>Are you sure you would like to Reject Leave Cancellation for selected leave requests?</p>
                    <div className="mb-4">
                      <label htmlFor="reason" className="block text-sm font-medium text-gray-700 mb-1">
                      Approver Comment
                      </label>
...
export default LeavePendingApp;