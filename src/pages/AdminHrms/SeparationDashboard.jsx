...
const SeparationDashboard = () => {
  ...
  return (
    <div className="p-4">
      <div className="text-2xl font-bold ">Separation Applications</div>
      <p className='mb-4'>Employees who have requested for separation from the organisation are located here.</p>
      <div className="flex justify-between gap-4">
        <div className="bg-white p-6 w-96 rounded-lg shadow-custom-all-sides z-10">
          <div className="text-center font-bold text-lg">Total Separation Requests</div>
          <div className="flex flex-col gap-8 justify-around items-center mt-10">
            <div className="text-center">
              <FaExclamationCircle className="mx-auto text-orange-500" size={32} />
        ...
        <div className="text-center font-bold text-lg">Top Resignation Reasons over last 6 months</div></div>
      </div>
    </div>
  );
};
